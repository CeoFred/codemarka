...
export const CLASSROOM_ASYNC_VERIFICATION_INIT =
    'CLASSROOM_ASYNC_VERIFICATION_INIT'
export const CLASSROOM_RESET = 'CLASSROOM_RESET'
export const SET_DEFAULT_INPUT_OUTPUT_DEVICES =
    'SET_DEFAULT_INPUT_OUTPUT_DEVICES'
...
export const SET_DISPLAYING_MESSAGE_REACTION_PICKER =
    'SET_DISPLAYING_MESSAGE_REACTION_PICKER'
...
export const UNSET_EDIT_OR_DELETE_MESSAGE_DATA =
    'UNSET_EDIT_OR_DELETE_MESSAGE_DATA'
//cookies
