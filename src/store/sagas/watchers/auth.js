...
import { logoutSaga,checkAuthTimeoutSaga ,authLoginUserSaga,authRegisterUserSaga,saveUserData} from '../auth';
...
export function* watchAuth(){
    ...
    yield takeLatest(actionTypes.AUTH_USER_LOGIN_SUCCESS,saveUserData)
