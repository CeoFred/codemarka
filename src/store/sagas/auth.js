...
export function* authRegisterUserSaga({ email, password, username, field, firstname, lastname }) {
    ...
    const loginRequest = yield new Request(url, {
        ...
        cache: 'default',
        headers: myHeaders,
        body: JSON.stringify({ email, password, username, field, firstname, lastname }),
        mode: 'cors'
